"""
Django settings for gump_blog project.
...
SECRET_KEY = 'i!i7i+2k$i2rt8m=g7m6=0ict@vfggt)$yvta)1#yt^9#_vq+t'
...
WSGI_APPLICATION = 'gump_blog.wsgi.application'
