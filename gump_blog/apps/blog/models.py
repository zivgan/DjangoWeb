...
class Tag(models.Model):
    ...
    # make object display friendly on back-end
    def __str__(self):
        return self.name
    ...
    class Meta:
        ...
        db_table = "tag" # database table name
...
class Article(models.Model):
    ...
    last_mod_time = models.DateTimeField(verbose_name='修改时间', default=now)
    # many to one , Article is many and Category is one. on_delete=models.CASCADE,当删除主表的数据时候从表中的数据也随着一起删除
